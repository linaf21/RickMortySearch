  ...
  return (
    <>
      {loading ? (<LoadingComponent />) : (
        <aside
          id="default-sidebar"
          className={`top-0 left-0 z-40 w-full h-screen md:w-96 md:h-auto md:relative ${hideSideMenu ? "hidden md:flex" : loading ? "md:flex" : ""
            }`}
          aria-label="Sidebar"
        >
          <div className="h-full px-4 py-4 overflow-y-auto shadow">
